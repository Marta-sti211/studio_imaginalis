    ...
    return (
        <div className="education">
            ...
            <ul>
                ...
                <li>
                2022 / present - SPACEX (Spatial Practices in Art & Architecture for Empathic Exchange). 
            ...
            <ul>
                <li>
                    2021/ 2022 - University of Amsterdam / Gerrit Rietveld Academie. Assistant to Dr Paula Albuquerque.
                </li>
                <li>
                    2021 / present - studio imaginalis. Academic Tutoring, Editing Services and Writing Consultancy.
                </li>
                <li>
            ...
            <ul>
                <li>
                French Academy in Rome - Villa Medici. Communications and Cultural Programming Internship, Supervisor: Arthur Godard-Saulgeot.
                </li>
            </ul>
            <h2>Education</h2>
                <ul>
                    <li>
                    2022/ [2023] - University of Amsterdam, rMA Arts and Performance Research Studies: Artistic Research Track. 
                    </li>
                    <li>
                    2017/ 2021 - University of Amsterdam, BA European Studies, cum laude.
                    </li>
                    <li>
                    2020 - University College London, Erasmus+ semester, BA European Studies.
                    </li>
                    <li>
                    2017 - Scuola Holden, Storytelling and Performing Arts Degree in Creative Writing. 
                    </li>
                </ul>
        </div>
    );
