...
function Work() {
            ...
            <h2>Published Work</h2>
                <h3>2022</h3>
                    <ul>
                        ...
                        <li>
                            Simulacrum Jrg. 30 # The documenta issue. ‘Bring a friend: learning with 
                            lumbung practices at documenta fifteen. Yazan Khalili and Eszter Szakács in conversation with 
                            Marta Pagliuca Pelacani’. Author.
                        </li>
                        <li>
    ...
    ">
                        ...
                        <li>
                        Simulacrum Jrg. 30 # Dirt. <i>DIRT Talks</i>: 'A Conversation with Lizan Freijsen’ and ‘An Interview with Semâ 
                        Bekirović'. Author.
                        </li>
                        <li>
                            Gerrit Rietveld Academie / University of Amsterdam, Art and Research. <i>Murmurs</i>: ‘Dodona’, text and poem. Co-author.
                        </li>
                    </ul>
                <h2>Editorial Work</h2>
                    <h3>2023</h3>
                        <ul>
                            <li>
                                Simulacrum Jrg. 31 # Water. Editor. 
                            </li>
                        </ul>
                    <h3>2022</h3>
                        <ul>
                    ...
                    <h3>2020</h3>
                        <ul>
                            <li>
                                French Academy in Rome - Villa Medici. <i>Cultural Programme 2020</i>. Translator, Copy editor and Copywriter. 
                            </li>
                        </ul>
        </div>
    );
